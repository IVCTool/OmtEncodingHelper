...
public class Platform_AttributesTest {
    ...
    void testAttributeSetterAndGetter() {
        ...
        } catch ( DecoderException | OmtEncodingHelperException | RTIinternalError | NameNotFound | InvalidObjectClassHandle | FederateNotExecutionMember | NotConnected | EncoderException e) {
            fail(e.getMessage());
        }
    }
