 ...
 * 
            <fixedRecordData>
                ...
                <field>
                    ...
                    <semantics>Use entity types from Supply Types, Expendibles or Sensors/Emitters tables  (SISO-REF-010-2010, 4.3), for aggregate entities, also use entity types from platform tables to describe the equipment type.</semantics>
                </field>
                <field>
 ...
 */
public class ObservedEquipmentStruct extends HLAfixedRecordStruct {
    ...
    public ObservedEquipmentStruct () throws RTIinternalError {
        super();
