...
package org.nato.ivct.OmtEncodingHelpers.Core.objects;
...
public class HLAobjectRoot extends HLAroot {
    ...
    public HLAobjectRoot() throws OmtEncodingHelperException {
        if (rtiAmbassador == null) {
            ...
            if (rtiAmbassador == null) throw new OmtEncodingHelperException("HLAobjectRoot not initialized"); 
        } 
     ...
     * @return
     */
    public String getHandleString(AttributeHandle handle) {
