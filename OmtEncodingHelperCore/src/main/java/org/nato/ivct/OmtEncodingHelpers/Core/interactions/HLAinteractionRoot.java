...
public class HLAinteractionRoot extends HLAroot {
     ...
     */
    public HLAinteractionRoot() throws NameNotFound, FederateNotExecutionMember, NotConnected, RTIinternalError, OmtEncodingHelperException {
    ...
    public ParameterHandleValueMap getParameterHandleValueMap() throws FederateNotExecutionMember, NotConnected, OmtEncodingHelperException {
        int nbValues = 0;
    ...
    public void send() throws InteractionClassNotPublished, InteractionParameterNotDefined, InteractionClassNotDefined, SaveInProgress, RestoreInProgress, FederateNotExecutionMember, NotConnected, RTIinternalError, OmtEncodingHelperException {
        HLAroot.getRtiAmbassador().sendInteraction(interactionClassHandle, getParameterHandleValueMap(), null);
    }

    public void subscribe() throws FederateServiceInvocationsAreBeingReportedViaMOM, InteractionClassNotDefined, SaveInProgress, RestoreInProgress, FederateNotExecutionMember, NotConnected, RTIinternalError, OmtEncodingHelperException {
        HLAroot.getRtiAmbassador().subscribeInteractionClass(interactionClassHandle);
    }

    public void publish() throws InteractionClassNotDefined, SaveInProgress, RestoreInProgress, FederateNotExecutionMember, NotConnected, RTIinternalError, OmtEncodingHelperException {
        ...
        if (handle == null) {
            try {
                handle = HLAroot.getRtiAmbassador().getParameterHandle(interactionClassHandle, name);
                    ...
                    | RTIinternalError | OmtEncodingHelperException e) {
    ...
    protected String getHandleString(ParameterHandle handle) {
        ...
        try {
            ...
            return handleName;
                ...
                | FederateNotExecutionMember | NotConnected | RTIinternalError | OmtEncodingHelperException e) {
